...
- Create a dataframe `ozplus` from the `geometry` variable using `purrr` functionality, and plot the result with the given code in the slide 16.
```{r}
